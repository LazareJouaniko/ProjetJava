...
public class SorcierDeck extends CardDeck {
    public SorcierDeck() {
        ...
        Monster monster1 = new Monster(1,"Sorcier1",2,2, MonsterTypeEnum.CLASSIC);
        Monster monster2 = new Monster(2,"Sorcier2",2,2, MonsterTypeEnum.CLASSIC);
        Monster monster3 = new Monster(3,"Sorcier3",2,2, MonsterTypeEnum.CLASSIC);
